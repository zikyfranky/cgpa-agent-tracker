...
export default function KnowledgeAtlas() {
  ...
  // Filter Courses based on Level/Semester would ideally come from a Result/Registrations table
  // But here we derive from the topics themselves if possible, or usually we'd have a course list.
                  ...
                  <div className="flex-1 overflow-y-auto p-10 prose prose-invert prose-indigo max-w-none no-scrollbar">
                      {readingTopic.content ? (
                          ...
                          <div className="py-20 text-center space-y-6">
                              ...
                              <div>
                                <p className="text-lg font-black text-white uppercase italic">Deep content restricted</p>
                                <p className="text-xs text-gray-600 font-bold uppercase tracking-widest mt-2">Analysis engine failed to compound text blocks for this node</p>
                              </div>
                          </div>
                      )}
                  </div>
